...
interface ApplicationInformationRepository {
    ...
    fun findAllApplicationsAsync(): Deferred<List<ApplicationInformation>> // 追加
    fun findApplicationByPackageNameAsync(packageName: String): Deferred<ApplicationInformation?> // 追加
}
...
class ApplicationInformationListAdapter : RecyclerView.Adapter<ApplicationInformationListAdapter.ViewHolder>() {
    ...
    interface OnItemClickListener {
        fun onItemClick(index: Int, binding: ViewApplicationInformationListRowBinding)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        binding.viewModel = ApplicationInformationListRowViewModel(object : ApplicationInformationListRowViewModel.Injector { // (1)
